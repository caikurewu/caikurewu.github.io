...
- [Explicit solution to the economic index of riskiness](https://www.sciencedirect.com/science/article/pii/S0165176523003683), with Zhenyu Cui and [Lingjiong Zhu](https://sites.google.com/view/lingjiongzhu/home?authuser=0).  _Economics Letters_, 232, 111343.
  <details>
    <summary style="list-style-type: circle;">Abstract</summary>
...
- [Variance optimality of empirical martingale simulation estimators](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4605168), with Zhenyu Cui, [Yanchu Liu](https://lingnan.sysu.edu.cn/en/faculty/LiuYanchu), [Ruodu Wang](https://sas.uwaterloo.ca/~wang/) and Lingjiong Zhu. Working Paper. Also available at: [[ResearchGate]](https://www.researchgate.net/publication/374778426_Variance_Optimality_of_Empirical_Martingale_Simulation_Estimators)
  <details>
    <summary style="list-style-type: circle;">Abstract</summary>
...
- Adding and subtracting Merton: A new approach for optimal portfolio and consumption, with Zhenyu Cui, [Kailin Ding](https://teacher.njust.edu.cn/jjgl/dkl_en/list.htm), and Yanchu Liu. Working Paper. Also available at: [[ResearchGate]](https://www.researchgate.net/publication/374778426_Variance_Optimality_of_Empirical_Martingale_Simulation_Estimators)

- [An exact explicit solution to the adjustment coefficient in risk theory](https://www.researchgate.net/publication/373191492_An_exact_explicit_solution_to_the_adjustment_coefficient_in_risk_theory), with Zhenyu Cui. Permanent working paper.
  <details>
    <summary style="list-style-type: circle;">Abstract</summary>
