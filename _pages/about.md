...
My primary research interest lies in Quantitative Finance, with a particular concentration on Decentralized Finance and Financial Technology. I am open to other fields like E-sports Analytics, and general Operations Research as well as Operations Management with real-world applications. Please feel free to reach out to talk about if you want to talk about research, music, or if you are interested in Chinese and Japanese culture.
...
======
- [VIX options valuation via continuous-time Markov chain approximation and Ito-Taylor expansion](https://www.pm-research.com/content/iijderiv/32/1/11), with [Zhenyu Cui](https://sites.google.com/site/zhenyucui86/home?authuser=0), [Chihoon Lee](https://www.stevens.edu/profile/clee4) and Mingzhe Liu. _Journal of Derivatives_, 32(1), 11-31.
  <details>
...
- [Explicit solution to the economic index of riskiness](https://www.sciencedirect.com/science/article/pii/S0165176523003683), with [Zhenyu Cui](https://sites.google.com/site/zhenyucui86/home?authuser=0) and [Lingjiong Zhu](https://sites.google.com/view/lingjiongzhu/home?authuser=0).  _Economics Letters_, 232, 111343.
  <details>
    <summary style="list-style-type: circle;">Abstract</summary>
...
- Adding and subtracting Merton: A new approach for optimal portfolio and consumption, with [Zhenyu Cui](https://sites.google.com/site/zhenyucui86/home?authuser=0), [Kailin Ding](https://teacher.njust.edu.cn/jjgl/dkl_en/list.htm), and [Yanchu Liu](https://lingnan.sysu.edu.cn/en/faculty/LiuYanchu). Working Paper. Also available at: [[ResearchGate]](https://www.researchgate.net/publication/374778426_Variance_Optimality_of_Empirical_Martingale_Simulation_Estimators)
  <!-- <details>
    <summary style="list-style-type: circle;">Abstract</summary>
  </details> -->

- [An exact explicit solution to the adjustment coefficient in risk theory](https://www.researchgate.net/publication/373191492_An_exact_explicit_solution_to_the_adjustment_coefficient_in_risk_theory), with [Zhenyu Cui](https://sites.google.com/site/zhenyucui86/home?authuser=0). Permanent working paper.
  <details>
    <summary style="list-style-type: circle;">Abstract</summary>
